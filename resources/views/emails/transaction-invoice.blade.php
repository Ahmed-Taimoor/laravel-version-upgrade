                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td class="esd-block-text es-m-txt-c" align="left">
                                                                                <img src="https://cdn.shortpixel.ai/client/q_lossless,ret_img/https://logoengine.net/wp-content/themes/logo-mart/assets/images/logo.png">
                                                                            </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            ...
                                                            <tr>
                                                                <td class="esd-block-text es-p10t es-p10b es-p10r es-p10l" align="left">
                                                                    <table style="width: 500px;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left">
                                                                        ...
                                                                        <tr>
                                                                            <td style="padding: 5px 10px 5px 0" width="80%" align="left">
                                                                                <p>{!! $transaction->item_name !!} (1)</p>
                                                                            </td>
                                                                            <td style="padding: 5px 0" width="20%" align="left">
                                                                                <p>${!! number_format($transaction->item_amount,2) !!}</p>
                                                                            </td>
                                                                        </tr {!! $offer = $transaction->discountOffer !!}>
                                                                        @if($offer)
                                                                        <tr>
                                                                            <td style="padding: 5px 10px 5px 0" width="80%" align="left">
                                                                                <p>{!! $offer->title !!}</p>
                                                                            ...
                                                                            <td style="padding: 5px 0" width="20%" align="left">
                                                                                <p>{!! $offer->type == 'percentage' ? $offer->offer_value.'%' : '$'.number_format($offer->offer_value,2) !!}</p>
                                                                            </td>
                                                                        </tr>
                                                                        @endif
                                                                        </tbody>
                                                                ...
                                                                <td class="esd-block-text es-p15t es-p15b es-p10r es-p10l" align="left">
                                                                    <table style="width: 500px;" class="cke_show_border" cellspacing="1" cellpadding="1" border="0" align="left">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td width="20%">
                                                                                <h4>${!! number_format($transaction->total_amount,2) !!}</h4>
                                                                            </td>
                                                                        </tr>
                                                                        </tbody>
                                                                    </table>
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <tr>
                                                                <td class="esd-block-text es-p10b" align="left">
                                                                    ...
                                                                    <p>{!! $transaction->state.', '.$transaction->city.' '.$transaction->zip_code !!}</p>
                                                                    <p>Phone: {!! $transaction->contact_number !!}</p>
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
